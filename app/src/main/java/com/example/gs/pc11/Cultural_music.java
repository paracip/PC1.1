...
public class Cultural_music extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cultural_music);
    ...
    protected void onStart() {
        ...
        DatabaseReference message1Ref = mRootRef.child("music_content");
        DatabaseReference message2Ref = mRootRef.child("music_contact");

        music_content = (TextView) findViewById(R.id.music_content);
        music_contact = (TextView) findViewById(R.id.music_contact);

        message1Ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                String message = dataSnapshot.getValue(String.class);
                music_content.setText(message);
            }
